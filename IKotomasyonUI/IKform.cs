...
namespace IKotomasyon.UI
{
    public partial class IKform : Form
    {
        ...
        public IKform(Kullanici kullanici)
        {
            InitializeComponent();
        ...
        private void departmanpanel_Paint(object sender, PaintEventArgs e)
        {
            //paint yok.
        }
        ...
        private void YöneticiIzinpb_Click(object sender, EventArgs e)
        {
            YöneticiIzinform frm = new YöneticiIzinform();
            frm.Show();
        }
        ...
        {
            PerformansIK frm = new PerformansIK();
            frm.Show();
        }
